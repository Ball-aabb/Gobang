...
int a[15][15],f,wx,wy,hh,ohh,mode,PID,time1,time2,time3=30,s1=1,s2=1,bkcolor,textcolor,linecolor,timecolor,bkci=1,tci=0,lci=0,timeci=0,colorn=10,colorl[]={0,WHITE,RGB(165,42,42),RGB(255,140,0),RGB(255,215,0),RGB(46,139,87),RGB(0,191,255),RGB(190,190,190),BROWN,RGB(180,82,205)},checkPattern(int x,int y,int player);
char c[30];
...
int main(){
    ...
    outtextxy(770,276,"退出 (E)");
    roundrect(750,340,850,400,30,30);
    outtextxy(770,356,"认输 (G)");
