...
1.开服牢玩家都知道，本项目最早的版本并不是*beta-250825*，而是*beta-250821*，其中就有有关AI功能的文件和代码，但因为使用体验极差、延时高及各种安全问题和一次git造成事故，AI功能和这个版本一起消失了。（骗你的，只是版本没有了，文件和代码都在）

2.开服牢玩家都知道，本项目所花的经费总计为0.01 CNY，是用于测试AI功能所花的API调用费（总共就928 tokens）。

3.开服牢玩家都不知道，本项目是在2025.8.2立项的。